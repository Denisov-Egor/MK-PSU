...
CREATE TABLE IF NOT EXISTS `Выпускники учебного заведения`.`Выпускник` (
  ...
  `ЦТ_Количество баллов` INT NOT NULL,
  PRIMARY KEY (`Код_выпускника`),
  UNIQUE INDEX `Код_выпускника_UNIQUE` (`Код_выпускника` ASC) VISIBLE,
  INDEX `fk_Выпускник_ЦТ1_idx` (`ЦТ_Количество баллов` ASC) VISIBLE,
  CONSTRAINT `fk_Выпускник_ЦТ1`
    FOREIGN KEY (`ЦТ_Количество баллов`)
    REFERENCES `Выпускники учебного заведения`.`ЦТ` (`Количество баллов`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Выпускники учебного заведения`.`Учебное заведение` (
  ...
  `Выпускник_Код_выпускника` INT NOT NULL,
  PRIMARY KEY (`Код_учебного_заведения`),
  UNIQUE INDEX `Код_учебного_заведения_UNIQUE` (`Код_учебного_заведения` ASC) VISIBLE,
  INDEX `fk_Учебное заведение_Выпускник1_idx` (`Выпускник_Код_выпускника` ASC) VISIBLE,
  CONSTRAINT `fk_Учебное заведение_Выпускник1`
    FOREIGN KEY (`Выпускник_Код_выпускника`)
...
CREATE TABLE IF NOT EXISTS `Выпускники учебного заведения`.`Трудоустройство` (
  ...
  INDEX `fk_Трудоустройство_Выпускник1_idx` (`Выпускник_Код_выпускника` ASC) VISIBLE,
  CONSTRAINT `fk_graduates_employment`
    FOREIGN KEY ()
    REFERENCES `Выпускники учебного заведения`.`Трудоустройство` ()
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Трудоустройство_Выпускник1`
    FOREIGN KEY (`Выпускник_Код_выпускника`)
    REFERENCES `Выпускники учебного заведения`.`Выпускник` (`Код_выпускника`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
